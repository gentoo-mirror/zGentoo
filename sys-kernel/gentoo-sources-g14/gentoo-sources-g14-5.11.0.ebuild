...
src_unpack() {
	...
	if use fanmode_hotkey; then
		...
		eapply "${FILESDIR}/0002-HID-ASUS-Add-support-for-ASUS-N-Key-keyboard_fanmode.patch" || die # fixes ASUS ROG NKey Keyboard devices fan mode keypress (experimental)
	fi
