...
COMMON_DEPEND="
	...
	=media-libs/gegl-0.4.26-r1[cairo,introspection]
	>=media-libs/gexiv2-0.10.6
	>=media-libs/harfbuzz-0.9.19
	>=media-libs/lcms-2.8:2
	>=media-libs/libmypaint-2.0.0_beta1
...
PATCHES=(
	"${FILESDIR}/${P}_fix_test-appdata.patch"
	"${FILESDIR}/${P}_fix_libmypaint.patch" # libmypaint 2.0.0
)
