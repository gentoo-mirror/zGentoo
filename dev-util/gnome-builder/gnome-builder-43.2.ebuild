...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="clang doc flatpak +git +glade gtk-doc spell +sysprof test +webkit"
REQUIRED_USE="
	${PYTHON_REQUIRED_USE}
	flatpak? ( git )
"
...
RDEPEND="
	...
	>=gui-libs/vte-0.70.0[introspection]
	>=dev-libs/libxml2-2.9.0
	webkit? ( >=net-libs/webkit-gtk-2.38.0-r500:5=[introspection] )
	sysprof? (
...
src_configure() {
	local emesonargs=(
		...
		-Dplugin_rust_analyzer=false
		-Dplugin_shellcmd=true
		-Dplugin_sphinx_preview=true
