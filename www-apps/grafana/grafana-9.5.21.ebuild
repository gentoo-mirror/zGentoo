...
# >> go work vendor && mkdir grafana-${version} && mv vendor grafana-${version}/vendor
...
KEYWORDS="~amd64"
IUSE="systemd"
RESTRICT="test" # tests not working due to network-sandbox (a proper fix would take to long)
...
src_prepare() {
	...
	mv ${DISTDIR}/yarn-4.3.1.cjs .yarn/releases/ || die "could not copy yarn-4.3.1.cjs"
