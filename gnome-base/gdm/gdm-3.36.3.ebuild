...
IUSE="accessibility audit bluetooth-sound branding elogind fprint +introspection ipv6 plymouth prime selinux smartcard systemd tcpd test wayland xinerama"
RESTRICT="!test? ( test )"
...
src_prepare() {
	...
	# enables prime-switch
	use prime && eapply "${FILESDIR}/${P}-nvidia-prime.patch"
